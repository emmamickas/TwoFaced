...
public class GruntBehavior : BaseEnemyBehavior
{
    ...
    {
        this.projectileName = "GruntProjectile";
    ...
    protected override void Shoot()
    {
        ...
        ProjectileManager.enemyProjectiles.Add(newProjectileObject.name, new GruntProjectile(new Vector3(projectileDirection.x, projectileDirection.y, 0), 20f, newProjectileObject.name, 1, 1, 1, 1));
        ...
        SoundEffectManager.PlayGruntShoot();
    }
