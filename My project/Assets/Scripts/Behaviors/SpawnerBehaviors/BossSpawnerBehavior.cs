...
public class BossSpawnerBehavior : BaseEnemySpawnerBehavior
{
    protected override void Spawn()
    {
        ...
        EnemyManager.enemies.Add(newEnemyObject.name, new Boss(newEnemyObject.name, 1, 1, 5f, 1f, 0.8f, 1f, newEnemyObject, SoundEffectManager.soundEffectManagerInstance.bossShoot, 100));
        ...
        SoundEffectManager.PlayBossSpawn();
    }
}
